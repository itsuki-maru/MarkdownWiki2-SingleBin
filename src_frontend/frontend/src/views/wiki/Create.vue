...
<template>
  ...
  <div id="overlay-image-preview" v-show="imagePreviewModal">
    <div id="content-image-view">
      <div v-html="imageFileSrc" id="image-preview"></div>
      <div class="btn-zone">
  ...
  <transition>
    <div id="overlay-help" v-show="showHelpContent">
      <div id="content-help">
        <Help></Help>
        <button v-on:click="onCloseHelpModal(0)">閉じる</button>
      </div>
    </div>
  </transition>
  <footer>
...
h3#title_h3_1:before {
  ...
  border-bottom: solid 15px rgb(23, 155, 126);
}
...
h3#title_h3_1:after {
  ...
  left: 0px;
  width: 100%;
  border-bottom: solid 3px rgb(23, 155, 126);
}
